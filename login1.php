...
<body>
				...
				<h1 align="center" style="font-size: 65px; color: maroon; font-family:Optima; top:5%; left:45%; position: absolute; ">Login</h1>	
		
			<div class="new_account" style="background-color: transparent; width:350px; height: 350px; top: 25%; left: 38%; position: absolute; border-style: solid; border-color: maroon;">
			<p style="color:black;">
...
<form id="login" action="login1.php" method="POST">
			...
			<legend style="color:darkred;" align="center"><b>PERSONAL DETAILS:</b></legend><br>
...
<br><br>
&emsp;&emsp;&emsp;&emsp;<input type= "Submit" class="buttonz" value="Login">
&emsp;
...
select * FROM CUSTOMER WHERE Password = '$pass' AND Username = '$user' ");
		...
		{
		      echo nl2br("\n\n&emsp;&emsp;&emsp;Username and password do not match. Try again");
		}
