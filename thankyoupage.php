...
<img src="PAM_LOGO.jpg" style="top:1%; left:42.5%; position:absolute; width:80px; height:80px;">

<p align="center" style="color:darkred; font-family:Optima;">Thank you for shopping with PAM! <br>Your delicious pizzas will be delivered to you shortly. <br><br><br>

<a href="homepage1.html">Still hungry? Order again!</a>
...
<!-------------------------------------------------------------------------------------->
	<a href="homepage1.html"><div class="logo"  style=" height: 85px; width: 100%;top:-1%; position: fixed;">
			<p><img align="center" src="PAM_LOGO.jpg" style="height: 70px; width: 70px; top:-3%; left: 40%; position: absolute;"><b style=" font-size: 28px; left:45%; top:16%; position: absolute; font-family:Optima;">PAM....Pizzas And More</b></p>
		</div></a>
...
$sql1 = "SELECT * FROM ORDER_ID WHERE Orderno=$billno";
...
if($result1)
        ...
        while($row1 = mysqli_fetch_assoc($result1))
      {
           ...
           $itemid=$row1['Itemid'];
           $sql2="INSERT INTO BILL_ID (Billno, Itemid) VALUES ($billno, '$itemid')";
...
$sql41="SELECT * FROM PAYMENT WHERE Reference_Number=($billno+109)";
...
$sql19 = "SELECT * FROM BILL WHERE Bill_Number=$billno";
...
$email=$row['Email'];
$amt=$row['Bill_Amount'];	
$sql2="INSERT INTO PAYMENT (Reference_Number, Mode_Of_Payment, Amount_To_Be_Paid, Email, Store_Id) VALUES ($billno+109, 'Cash', ($amt*1.2)+50, '$email', '$storeid')";
...
$sql3="UPDATE MISC SET STATUS='COMPLETED'";
$res3=mysqli_query($conn, $sql3);

$sql4="UPDATE ORDI SET QTY=0, PRICE=0";
